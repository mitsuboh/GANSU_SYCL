...
SYCL_EXTERNAL
void compute_gradients_overlap(const sycl::nd_item<1>& item_ct1, double* g_gradients, const real_t* g_W_matrix, const PrimitiveShell* g_shell, const real_t* g_cgto_normalization_factors, 
