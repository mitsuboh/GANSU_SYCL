...
#include "device_function_grad_v_s.txt"
...
SYCL_EXTERNAL
void compute_gradients_nuclear(const sycl::nd_item<1>& item_ct1, double* g_gradients, const real_t* g_density_matrix, const PrimitiveShell* g_shell, const real_t* g_cgto_normalization_factors,
