...
SYCL_EXTERNAL
void compute_gradients_two_electron_uhf(const sycl::nd_item<1>& item_ct1, double* g_gradients, const real_t* g_density_matrix_a, const real_t* g_density_matrix_b,
