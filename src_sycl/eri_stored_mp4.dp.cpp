...
// children tags
struct mp4_E1_1 : mp4_E1_tag {};
struct mp4_E1_2 : mp4_E1_tag {};
struct mp4_E1_3 : mp4_E1_tag {};
struct mp4_E1_4 : mp4_E1_tag {};

struct mp4_E2_1  : mp4_E2_tag {};
struct mp4_E2_2  : mp4_E2_tag {};
struct mp4_E2_3  : mp4_E2_tag {};
struct mp4_E2_4  : mp4_E2_tag {};
struct mp4_E2_5  : mp4_E2_tag {};
struct mp4_E2_6  : mp4_E2_tag {};
struct mp4_E2_7  : mp4_E2_tag {};
struct mp4_E2_8  : mp4_E2_tag {};
struct mp4_E2_9  : mp4_E2_tag {};
struct mp4_E2_10 : mp4_E2_tag {};
struct mp4_E2_11 : mp4_E2_tag {};
struct mp4_E2_12 : mp4_E2_tag {};

struct mp4_E3_1  : mp4_E3_tag {};
struct mp4_E3_2  : mp4_E3_tag {};
struct mp4_E3_3  : mp4_E3_tag {};
struct mp4_E3_4  : mp4_E3_tag {};
struct mp4_E3_5  : mp4_E3_tag {};
struct mp4_E3_6  : mp4_E3_tag {};
struct mp4_E3_7  : mp4_E3_tag {};
struct mp4_E3_8  : mp4_E3_tag {};
struct mp4_E3_9  : mp4_E3_tag {};
struct mp4_E3_10 : mp4_E3_tag {};
struct mp4_E3_11 : mp4_E3_tag {};
struct mp4_E3_12 : mp4_E3_tag {};
struct mp4_E3_13 : mp4_E3_tag {};
struct mp4_E3_14 : mp4_E3_tag {};
struct mp4_E3_15 : mp4_E3_tag {};
struct mp4_E3_16 : mp4_E3_tag {};

struct mp4_E4_1 : mp4_E4_tag {};
struct mp4_E4_2 : mp4_E4_tag {};
struct mp4_E4_3 : mp4_E4_tag {};
struct mp4_E4_4 : mp4_E4_tag {};

template <typename Term>
void compute_mp4_body(
    sycl::nd_item<1> item,
...
SYCL_EXTERNAL void mp3_moeri_4h2p_kernel(
                                         sycl::nd_item<1> item_ct1,
                                         const double *__restrict__ eri_mo,
                                         const double *__restrict__ eps,
                                         const int num_basis, const int occ,
                                         double *__restrict__ E_out);
SYCL_EXTERNAL void mp3_moeri_2h4p_kernel(
                                         sycl::nd_item<1> item_ct1,
                                         const double *__restrict__ eri_mo,
                                         const double *__restrict__ eps,
                                         const int num_basis, const int occ,
                                         double *__restrict__ E_out);
SYCL_EXTERNAL void mp3_moeri_3h3p_kernel(
                                         sycl::nd_item<1> item_ct1,
                                         const double *__restrict__ eri_mo,
                                         const double *__restrict__ eps,
                                         const int num_basis, const int occ,
...
compute_mp4_E1_1_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E1_1>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
...
compute_mp4_E1_2_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E1_2>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
                             ...
                             real_t *__restrict__ d_mp4_energy_E1_2)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E1_2, block_sum);
    }
}

/*
DPCT1110:29: The total declared local variable size in device function
compute_mp4_E1_3_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E1_3>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
                             ...
                             real_t *__restrict__ d_mp4_energy_E1_3)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E1_3, block_sum);
    }
}

/*
DPCT1110:30: The total declared local variable size in device function
compute_mp4_E1_4_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E1_4>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
                             ...
                             real_t *__restrict__ d_mp4_energy_E1_4)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E1_4, block_sum);
    }
}


template <>
void compute_mp4_body<mp4_E2_1>(
                                          sycl::nd_item<1> item_ct1,
                                          const real_t* __restrict__ eri_mo,
                                          const real_t* __restrict__ orbital_energies,
                                          const int num_basis,
                                          ...
                                          real_t* __restrict__ d_mp4_energy_E2_1)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E2_1, block_sum);
    }
}
...
compute_mp4_E2_2_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E2_2>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
                             ...
                             real_t *__restrict__ d_mp4_energy_E2_2)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E2_2, block_sum);
    }
}

/*
DPCT1110:32: The total declared local variable size in device function
compute_mp4_E2_3_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E2_3>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
                             ...
                             real_t *__restrict__ d_mp4_energy_E2_3)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E2_3, block_sum);
    }
}

/*
DPCT1110:33: The total declared local variable size in device function
compute_mp4_E2_4_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E2_4>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
                             ...
                             real_t *__restrict__ d_mp4_energy_E2_4)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E2_4, block_sum);
    }
}

/*
DPCT1110:34: The total declared local variable size in device function
compute_mp4_E2_5_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E2_5>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
                             ...
                             real_t *__restrict__ d_mp4_energy_E2_5)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E2_5, block_sum);
    }
}

/*
DPCT1110:35: The total declared local variable size in device function
compute_mp4_E2_6_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E2_6>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
                             ...
                             real_t *__restrict__ d_mp4_energy_E2_6)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E2_6, block_sum);
    }
}
...
template <>
void compute_mp4_body<mp4_E2_7>(
                             sycl::nd_item<1> item_ct1,
                                          const real_t* __restrict__ eri_mo,
                                          const real_t* __restrict__ orbital_energies,
                                          const int num_basis,
                                          ...
                                          real_t* __restrict__ d_mp4_energy_E2_7)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E2_7, block_sum);
    }
}

/*
DPCT1110:36: The total declared local variable size in device function
compute_mp4_E2_8_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E2_8>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
                             ...
                             real_t *__restrict__ d_mp4_energy_E2_8)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E2_8, block_sum);
    }
}

/*
DPCT1110:37: The total declared local variable size in device function
compute_mp4_E2_9_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E2_9>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
                             ...
                             real_t *__restrict__ d_mp4_energy_E2_9)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E2_9, block_sum);
    }
}

/*
DPCT1110:38: The total declared local variable size in device function
compute_mp4_E2_10_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E2_10>(
                             sycl::nd_item<1> item_ct1,
                              const real_t *__restrict__ eri_mo,
                              const real_t *__restrict__ orbital_energies,
                              const int num_basis, const int num_spin_occ,
                              ...
                              real_t *__restrict__ d_mp4_energy_E2_10)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E2_10, block_sum);
    }
}

/*
DPCT1110:39: The total declared local variable size in device function
compute_mp4_E2_11_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E2_11>(
                             sycl::nd_item<1> item_ct1,
                              const real_t *__restrict__ eri_mo,
                              const real_t *__restrict__ orbital_energies,
                              const int num_basis, const int num_spin_occ,
                              ...
                              real_t *__restrict__ d_mp4_energy_E2_11)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E2_11, block_sum);
    }
}

/*
DPCT1110:40: The total declared local variable size in device function
compute_mp4_E2_12_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E2_12>(
                             sycl::nd_item<1> item_ct1,
                              const real_t *__restrict__ eri_mo,
                              const real_t *__restrict__ orbital_energies,
                              const int num_basis, const int num_spin_occ,
                              ...
                              real_t *__restrict__ d_mp4_energy_E2_12)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E2_12, block_sum);
    }
}

/*
DPCT1110:41: The total declared local variable size in device function
compute_mp4_E3_1_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E3_1>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
...
*/
template <>
void compute_mp4_body<mp4_E3_2>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
...
/*
DPCT1110:43: The total declared local variable size in device function
compute_mp4_E3_3_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E3_3>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
...
*/
template <>
void compute_mp4_body<mp4_E3_4>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
...
compute_mp4_E3_5_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E3_5>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
...
*/
template <>
void compute_mp4_body<mp4_E3_6>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
...
compute_mp4_E3_7_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E3_7>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
...
*/
template <>
void compute_mp4_body<mp4_E3_8>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
...
compute_mp4_E3_9_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E3_9>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
...
*/
template <>
void compute_mp4_body<mp4_E3_10>(
                             sycl::nd_item<1> item_ct1,
                              const real_t *__restrict__ eri_mo,
                              const real_t *__restrict__ orbital_energies,
                              const int num_basis, const int num_spin_occ,
...
compute_mp4_E3_11_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E3_11>(
                             sycl::nd_item<1> item_ct1,
                              const real_t *__restrict__ eri_mo,
                              const real_t *__restrict__ orbital_energies,
                              const int num_basis, const int num_spin_occ,
...
*/
template <>
void compute_mp4_body<mp4_E3_12>(
                             sycl::nd_item<1> item_ct1,
                              const real_t *__restrict__ eri_mo,
                              const real_t *__restrict__ orbital_energies,
                              const int num_basis, const int num_spin_occ,
...
/*
DPCT1110:53: The total declared local variable size in device function
compute_mp4_E3_13_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E3_13>(
                             sycl::nd_item<1> item_ct1,
                              const real_t *__restrict__ eri_mo,
                              const real_t *__restrict__ orbital_energies,
                              const int num_basis, const int num_spin_occ,
...
*/
template <>
void compute_mp4_body<mp4_E3_14>(
                             sycl::nd_item<1> item_ct1,
                              const real_t *__restrict__ eri_mo,
                              const real_t *__restrict__ orbital_energies,
                              const int num_basis, const int num_spin_occ,
...
compute_mp4_E3_15_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E3_15>(
                             sycl::nd_item<1> item_ct1,
                              const real_t *__restrict__ eri_mo,
                              const real_t *__restrict__ orbital_energies,
                              const int num_basis, const int num_spin_occ,
...
*/
template <>
void compute_mp4_body<mp4_E3_16>(
                             sycl::nd_item<1> item_ct1,
                              const real_t *__restrict__ eri_mo,
                              const real_t *__restrict__ orbital_energies,
                              const int num_basis, const int num_spin_occ,
...
compute_mp4_E4_1_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E4_1>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
...
{
    size_t total =
        (size_t)num_spin_occ * num_spin_occ * num_spin_occ * num_spin_occ;
    size_t gid = (size_t)item_ct1.get_global_linear_id();
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E4_1, block_sum);
    }
}

/*
DPCT1110:58: The total declared local variable size in device function
compute_mp4_E4_2_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E4_2>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
                             ...
                             real_t *__restrict__ d_mp4_energy_E4_2)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E4_2, block_sum);
    }
}

/*
DPCT1110:59: The total declared local variable size in device function
compute_mp4_E4_3_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E4_3>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
                             ...
                             real_t *__restrict__ d_mp4_energy_E4_3)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E4_3, block_sum);
    }
}

/*
DPCT1110:60: The total declared local variable size in device function
compute_mp4_E4_4_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
template <>
void compute_mp4_body<mp4_E4_4>(
                             sycl::nd_item<1> item_ct1,
                             const real_t *__restrict__ eri_mo,
                             const real_t *__restrict__ orbital_energies,
                             const int num_basis, const int num_spin_occ,
                             ...
                             real_t *__restrict__ d_mp4_energy_E4_4)
{
    ...
    double block_sum = sycl::reduce_over_group(item_ct1.get_group(), contrib, sycl::plus<>());
    if (item_ct1.get_local_id() == 0) {
        atomic_add(d_mp4_energy_E4_4, block_sum);
    }
}
    ...
    real_t* d_mp4_energy_term)
{
    switch (term_id) {
        ...
        // E2
        case 4:  launch_mp4_kernel<mp4_E2_1>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 5:  launch_mp4_kernel<mp4_E2_2>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 6:  launch_mp4_kernel<mp4_E2_3>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 7:  launch_mp4_kernel<mp4_E2_4>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 8:  launch_mp4_kernel<mp4_E2_5>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 9:  launch_mp4_kernel<mp4_E2_6>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 10:  launch_mp4_kernel<mp4_E2_7>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 11:  launch_mp4_kernel<mp4_E2_8>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 12:  launch_mp4_kernel<mp4_E2_9>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 13:  launch_mp4_kernel<mp4_E2_10>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 14:  launch_mp4_kernel<mp4_E2_11>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 15:  launch_mp4_kernel<mp4_E2_12>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;

        // E3
        case 16: launch_mp4_kernel<mp4_E3_1>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 17: launch_mp4_kernel<mp4_E3_2>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 18: launch_mp4_kernel<mp4_E3_3>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 19: launch_mp4_kernel<mp4_E3_4>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 20: launch_mp4_kernel<mp4_E3_5>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 21: launch_mp4_kernel<mp4_E3_6>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 22: launch_mp4_kernel<mp4_E3_7>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 23: launch_mp4_kernel<mp4_E3_8>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 24: launch_mp4_kernel<mp4_E3_9>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 25: launch_mp4_kernel<mp4_E3_10>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 26: launch_mp4_kernel<mp4_E3_11>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 27: launch_mp4_kernel<mp4_E3_12>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 28: launch_mp4_kernel<mp4_E3_13>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 29: launch_mp4_kernel<mp4_E3_14>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 30: launch_mp4_kernel<mp4_E3_15>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 31: launch_mp4_kernel<mp4_E3_16>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;

        // E4
        case 32: launch_mp4_kernel<mp4_E4_1>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 33: launch_mp4_kernel<mp4_E4_2>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 34: launch_mp4_kernel<mp4_E4_3>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
        case 35: launch_mp4_kernel<mp4_E4_4>(q, nd_range, eri_mo, orbital_energies, num_basis, num_spin_occ, num_spin_vir, d_mp4_energy_term); break;
...
real_t mp4_from_aoeri_via_full_moeri_factorization(
    const real_t *d_eri_ao, const real_t *d_coefficient_matrix,
...
//  sycl::queue &q_ct1 = dev_ct1.in_order_queue();
    ...
    q_ct1.memset(d_mp2_energy, 0.0, sizeof(real_t)).wait();
    {
        ...
        const int num_blocks = (int)((total + num_threads - 1) / num_threads);
        /*
        DPCT1083:61: The size of local memory in the migrated code may be
        ...
        */
...

        {
            ...
            q_ct1.parallel_for(
                ...
                [=](sycl::nd_item<1> item_ct1) {
                    mp2_moeri_kernel(item_ct1, d_eri_mo, d_orbital_energies, num_basis,
                                     num_occ, d_mp2_energy);
                });
        }
    ...
    q_ct1.memset(d_mp3_energy, 0.0, sizeof(real_t) * 3).wait();
    ...
    { // 4h2p term
        ...
        const int num_blocks = (int)((total + num_threads - 1) / num_threads);
        /*
        DPCT1083:62: The size of local memory in the migrated code may be
        different from the original code. Check that the allocated memory size
        in the migrated code is correct.
        */
        size_t shmem = (size_t)num_threads * sizeof(double);

        {
            ...
            q_ct1.submit([&](sycl::handler &cgh) {
                auto d_mp3_energy_ct4 = &d_mp3_energy[0];

                cgh.parallel_for(
                    sycl::nd_range<1>(sycl::range<1>(num_blocks * num_threads), sycl::range<1>(num_threads)),
                    [=](sycl::nd_item<1> item_ct1) {
                        mp3_moeri_4h2p_kernel(item_ct1, d_eri_mo, d_orbital_energies,
                                              num_basis, num_occ,
                                              d_mp3_energy_ct4);
                    });
            });
    ...
    { // 2h4p term
        ...
        const int num_blocks = (int)((total + num_threads - 1) / num_threads);
        /*
        DPCT1083:63: The size of local memory in the migrated code may be
        different from the original code. Check that the allocated memory size
        in the migrated code is correct.
        */
        size_t shmem = (size_t)num_threads * sizeof(double);

        {
            ...
            q_ct1.submit([&](sycl::handler &cgh) {
                auto d_mp3_energy_ct4 = &d_mp3_energy[1];

                cgh.parallel_for(
                    sycl::nd_range<1>(sycl::range<1>(num_blocks * num_threads), sycl::range<1>(num_threads)),
                    [=](sycl::nd_item<1> item_ct1) {
                        mp3_moeri_2h4p_kernel(item_ct1, d_eri_mo, d_orbital_energies,
                                              num_basis, num_occ,
                                              d_mp3_energy_ct4);
                    });
            });
    ...
    { // 3h3p term
        ...
        const int num_blocks = (int)((total + num_threads - 1) / num_threads);
        /*
        DPCT1083:64: The size of local memory in the migrated code may be
        different from the original code. Check that the allocated memory size
        in the migrated code is correct.
        */
        size_t shmem = (size_t)num_threads * sizeof(double);

        {
            ...
            q_ct1.submit([&](sycl::handler &cgh) {
                auto d_mp3_energy_ct4 = &d_mp3_energy[2];

                cgh.parallel_for(
                    sycl::nd_range<1>(sycl::range<1>(num_blocks * num_threads), sycl::range<1>(num_threads)),
                    [=](sycl::nd_item<1> item_ct1) {
                        mp3_moeri_3h3p_kernel(item_ct1, d_eri_mo, d_orbital_energies,
                                              num_basis, num_occ,
                                              d_mp3_energy_ct4);
                    });
            });
...
/*
    ...
    q_ct1.memset(d_mp4_energy, 0.0, sizeof(real_t) * num_mp4_terms).wait();
    q_ct1.wait_and_throw();

#ifdef USE_CUDA_STREAMS

    // Create sycl streams for overlapping computation
...
//    }
    ...
    for(int i=0; i<num_mp4_terms; i++){
        ...
        // Launch the kernel for the i-th MP4 term
//        mp4_term_kernel_t kernel = mp4_term_kernels[i];
//        dpct::kernel_launcher::launch(kernel, num_blocks, num_threads, shmem, 0,
//                                      d_eri_mo, d_orbital_energies, num_basis,
//                                      num_spin_occ, num_spin_vir,
//                                      &d_mp4_energy[i]);
        sycl::nd_range<1> nd_range(num_blocks * num_threads, num_threads);
        launch_mp4_kernel_dispatch(q_ct1, i, nd_range, d_eri_mo, d_orbital_energies,
                               num_basis, num_spin_occ, num_spin_vir,
                               &d_mp4_energy[i]);

        q_ct1.wait_and_throw();
        q_ct1.memcpy(&h_mp4_energy[i], &d_mp4_energy[i], sizeof(real_t)).wait();
