 ...
 */
 ...
 namespace gansu::gpu{
    ...
    __device__ __inline__ void addToResult_3center(double res, double *g_result, int p, int q, int r, int nCGTO, int nAux, bool is_prim_id_not_equal, const real_t* d_cgto_normalization_factors, const real_t* d_auxiliary_cgto_normalization_factors){
