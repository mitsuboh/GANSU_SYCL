...
- If you do not like this, you can use AOT compiling by adding CMakelists.txt something like, set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fsycl -fsycl-targets=spir64_gen -Xs \\\"-device 0x7d67\\\"")                                                                                    [Your device id: 0x7d67 ]
