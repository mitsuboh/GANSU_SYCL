 ...
 */
void ROHF::guess_initial_fock_matrix(const real_t* density_matrix_a, const real_t* density_matrix_b) {
    PROFILE_FUNCTION();
    ...
    }else if(initail_guess_method_ == "density"){ // Initial guess from density matrix
