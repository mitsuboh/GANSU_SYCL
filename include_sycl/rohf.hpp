...
public:
    ...
    /*
    DPCT1109:2: Virtual functions cannot be called in SYCL device code. You need
    to adjust the code.
    */
...
public:
    ...
    /*
    DPCT1109:3: Virtual functions cannot be called in SYCL device code. You need
    to adjust the code.
    */
...
public:
    ...
    sycl::queue &q_ct1 = dev_ct1.in_order_queue();
        ...
        { // open shell
            ...
            q_ct1
                .memcpy(hf_.get_density_matrix_open().device_ptr(),
                        density_matrix_open.get(),
                        hf_.get_num_basis() * hf_.get_num_basis() *
                            sizeof(real_t))
                .wait();
        }
        { // closed shell
            ...
            q_ct1
                .memcpy(hf_.get_density_matrix_closed().device_ptr(),
                        density_matrix_closed.get(),
                        hf_.get_num_basis() * hf_.get_num_basis() *
                            sizeof(real_t))
                .wait();
        }
...
*/
    ...
    sycl::queue &q_ct1 = dev_ct1.in_order_queue();
        ...
        q_ct1.memcpy(hf_.get_density_matrix_closed().device_ptr(),
                     density_matrix_closed.get(),
                     hf_.get_num_basis() * hf_.get_num_basis() *
                         sizeof(real_t));
        q_ct1
